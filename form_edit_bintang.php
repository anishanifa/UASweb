...
<div class="container-fluid">
	...
	<form action="proses_edit.php" method="post">
		...
		if ($jenis_edit == "bintang"){
			$id = $_GET['id'];
			$query = mysqli_query($host,"SELECT * FROM bintang WHERE id_bintang = '$id'") or die(mysqli_error($host,));
		...
		<table>
			<tr>
				...
				<td>
					<input type="hidden" name="id" value="<?php echo $data['id_bintang'] ?>">
			...
			<tr>
				<td>Nama Khas</td>
				<td><input type="text" name="nama_khas" value="<?php echo $data['nama_khas'] ?>" required></td>					
			</tr>	
			<tr>
				<td>Nama Modern</td>
				<td><input type="text" name="nama_modern" value="<?php echo $data['nama_modern'] ?>" required></td>					
			</tr>	
				<td></td>
