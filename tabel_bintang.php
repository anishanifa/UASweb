...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="form_tambah_bintang.php">+ Tambah Bintang Baru</a></h6>
                        </div>
                        <div class="card-body">
								...
								<tbody>
									<tr>
										...
										<td width="90px" align="center">
											<a href="form_edit_bintang.php?jenis=bintang&id=<?php echo $data['id_bintang']; ?>">Edit</a> | 
											<a href="proses_hapus.php?jenis=bintang&id=<?php echo $data['id_bintang']; ?>" onclick="return confirm('Yakin hapus data?')">Hapus</a>					
										</td>
									</tr>
								</tbody>
								<?php
